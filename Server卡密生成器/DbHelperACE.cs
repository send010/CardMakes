...
{ /// <summary> 
  ...
  /// </summary> 
    public abstract class DbHelperACE
    {
        ...
        public static string connectionString = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source='C:\Users\11641\Desktop\qnmb.mdb';Jet OLEDB:Database Password=LOLchaoshen"; 

        public DbHelperACE(string sqlstr)
        {
        ...
        public static int InsertMultipleSQL(string connectionString,List<string> sqlList)
        {
        ...
        public static string IsOpenConn(string connectionString)
        {
            string Error = "";
        ...
        public static DataSet Query(string SQLString)
        {
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    command.Fill(ds, "ds");//参数1 数据集 参数2 数据集填充的内存表名 
                }
